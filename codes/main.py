...
def main():
    ...
    training_losses_list = [loss.item() for loss in training_losses]
    validation_losses_list = [loss.item() for loss in validation_losses]

    # Save training losses to a file
    with open('training_losses2.json', 'w') as f:
        json.dump(training_losses_list, f)

    # Save validation losses to a file
    with open('validation_losses2.json', 'w') as f:
        json.dump(validation_losses_list, f)
